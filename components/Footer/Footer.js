      ...
      <div className='absolute inset-0 overflow-hidden pointer-events-none'>
        ...
        <div className='absolute top-1/3 right-32'>
          <svg
            ...
            height='80'
            viewBox='0 0 100 100'
            className='opacity-15 animate-spin-slow'
          >
            <polygon
        ...
        <div className='absolute top-1/4 left-1/4'>
          ...
          >
            <path
              d='M25.5 0L31.5 17.5H50L35.25 28L41 48L25.5 37L10 48L15.75 28L1 17.5H19.5L25.5 0Z'
              fill='#efc041'
            />
          </svg>
        </div>
        <div className='absolute top-2/3 right-1/4'>
          <svg
            ...
            height='30'
            viewBox='0 0 51 48'
            className='opacity-25 animate-pulse-slow animation-delay-2000'
          >
            <path
              d='M25.5 0L31.5 17.5H50L35.25 28L41 48L25.5 37L10 48L15.75 28L1 17.5H19.5L25.5 0Z'
              fill='#eeba2c'
        ...
        {/* Plus Signs */}
        <div className='absolute top-1/2 right-1/3 text-[#efc041] text-4xl font-bold opacity-20 animate-spin-slow'>
          +
        </div>
        <div className='absolute bottom-1/4 left-1/3 text-[#eeba2c] text-3xl font-bold opacity-15 animate-spin-slow animation-delay-2000'>
          +
        </div>
      </div>
