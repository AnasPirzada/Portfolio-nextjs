            ...
            <div className="relative w-full" style={{ height: '350px' }}>
                ...
                {stats.map((stat, statIndex) => {
                  ...
                  for (let i = 0; i < segments; i++) {
                    if (i % 2 === 0) {
                      ...
                      const x = i * stepX;
                      const variance =
                        Math.sin(((i + statIndex * 3) * Math.PI) / 6) * 0.3 +
                        0.7;
                      const y =
                        height - (stat.value / maxValue) * height * variance;
                      dataPoints.push({ x, y });
                    }
                  }
              ...
              <div className="flex justify-between mt-6 px-2 text-xs text-gray-500 font-medium">
                {[
                  ...
                  <span key={month} className="uppercase tracking-wider">
                    {month}
                  </span>
                ))}
              </div>
