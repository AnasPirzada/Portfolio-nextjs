...
export default function BlogDetail({ blog }) {
  ...
  const blogDescription = blog.description || `${blog.title} - A technical article by Anas Pirzada, Full Stack Developer & AI Expert.`;
  ...
  const articleSchema = {
    ...
    "keywords": blog.tags?.join(', ') || "web development, programming, technology"
  };
      ...
      <main className='section-container pt-24 pb-16'>
        ...
        <nav className='mb-6' aria-label="Breadcrumb">
          <ol className='flex items-center space-x-2 text-sm'>
            ...
            <li>
              <Link href={`/#${MENULINKS.find(m => m.ref === 'blogs') ? 'blogs' : ''}`} className='text-gray-400 hover:text-white transition-colors'>
                Blogs
              </Link>
            </li>
            <li className='text-gray-500'>›</li>
            <li className='text-white' aria-current="page">{blogTitle}</li>
          </ol>
        </nav>
          ...
          <div className='flex items-start gap-4'>
            ...
            <div>
              ...
              <p className='text-gray-300 leading-relaxed'>
                Anas Pirzada is a Full Stack Developer and AI Expert with 2+ years of experience in building 
                scalable web applications and AI-powered solutions. He specializes in React.js, Next.js, 
