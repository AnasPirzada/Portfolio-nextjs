...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id={MENULINKS[0].ref}
      className='w-full flex md:items-center py-8 2xl:container mx-auto xl:px-20 md:px-12 px-4 min-h-screen relative mb-8 md:mb-24'
      style={{ opacity: 0 }}
    >
      <style global jsx>
        {`
      ...
      <div className='flex flex-col pt-40 md:pt-0 select-none'>
        ...
        <p>
          <span
            ref={typedElementRef}
            className='staggered-reveal text-2xl text-gray-light-3 font-mono leading-relaxed'
          />
        </p>
